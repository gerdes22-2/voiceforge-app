...
with open("backend/app/providers/separation/melband.py", "w") as f:
...
with open("backend/app/providers/separation/demucs.py", "w") as f:
    f.write("""import asyncio
import os
import uuid
from typing import Dict, Any
...
with open("backend/app/providers/__init__.py", "a") as f:
    f.write("from app.providers.separation.melband import MelBandRoformerProvider\n")
    f.write("from app.providers.separation.demucs import DemucsProvider\n")
    f.write("ProviderRegistry.register(MelBandRoformerProvider)\n")
    f.write("ProviderRegistry.register(DemucsProvider)\n")
