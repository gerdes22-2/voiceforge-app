...
with open("backend/app/schemas/dataset.py", "w") as f:
...
with open("backend/app/api/v1/datasets.py", "w") as f:
...
with open("backend/app/api/v1/api.py", "a") as f:
    f.write("from app.api.v1 import datasets\n")
    f.write("api_router.include_router(datasets.router, prefix='/datasets', tags=['datasets'])\n")
